...
_CG_TUSHARE_SYMBOLS = None
pro = ts.pro_api('7804bdb8824c428d767ecd366f45c86d76f9d0a1f19a152dd2a90cbb')
...
class TushareCollector(BaseCollector):
    ...
    def get_data_from_remote(symbol, interval, start, end):
        ...
        try:
            ...
            # _resp = pro.pro_bar(ts_code=symbol, freq=freq, start_date=start_date, end_date=end_date)
            _resp = pro.daily(ts_code=symbol, start_date=start_date, end_date=end_date)
...
class TushareCollector1d(TushareCollector, ABC):
    def get_instrument_list(self):
        logger.info("get symbols......")
        symbols = get_tushare_symbols()
...
class Run(BaseRun):
    ...
    def collector_class_name(self):
        return f"TushareCollector{self.interval}"
